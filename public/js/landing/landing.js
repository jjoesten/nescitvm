...
// Fix page height and width on browser resize
...
$(document).ready(function() {
    ...
    // Drop down menus
    $("header hav ul li").hover(function() {
        ...
        $.ajax({
            ...
            if (response && response.result) {
                ...
                for (x in response.characters) {
                    ...
                    var label = "<label for='corp_char_"+x+"'><img src='https://image.eveonline.com/Character/"+character.characterID+"64.jpg' title='"+character.characterName+"' /></label>";
